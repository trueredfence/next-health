...
export default function Home() {
  ...
  const foodList = {
    ...
    choley:0, tea:0, salad:0, rice:0
  }

  const foodProrteinValue = {
    bread:1.4, oats:16.0, roti:3.0, idly:1.0, dosa:2.0, milk:6.8, pratha:4.1, puri:2.0, corn:6.6, dal:3.0, sambar:2.1, vegitable:0, fish:8.75, dahi:2.6, kichri:4.3, chicken:8.0, egg:7.0,
    choley:4.2, tea:1.0, salad:0, rice:7.5
   }
  ...
  const udateProtein = ()=>{  
    ...
    userHealthAssement.proteinIntake = Math.round(
        (foodProrteinValue.bread*foodItemsValues.bread)+(foodProrteinValue.oats*foodItemsValues.oats)+(foodProrteinValue.roti*foodItemsValues.roti)+(foodProrteinValue.idly*foodItemsValues.idly)+
        (foodProrteinValue.dosa*foodItemsValues.dosa)+(foodProrteinValue.milk*foodItemsValues.milk)+(foodProrteinValue.pratha*foodItemsValues.pratha)+(foodProrteinValue.puri*foodItemsValues.puri)+(foodProrteinValue.corn*foodItemsValues.corn)+(foodProrteinValue.dal*foodItemsValues.dal)+(foodProrteinValue.sambar*foodItemsValues.sambar)+(foodProrteinValue.vegitable*foodItemsValues.vegitable)+(foodProrteinValue.fish*foodItemsValues.fish)+(foodProrteinValue.dahi*foodItemsValues.dahi)+(foodProrteinValue.kichri*foodItemsValues.kichri)+(foodProrteinValue.chicken*foodItemsValues.chicken)+(foodProrteinValue.choley*foodItemsValues.choley)+(foodProrteinValue.tea*foodItemsValues.tea)+(foodProrteinValue.salad*foodItemsValues.salad)+(foodProrteinValue.rice*foodItemsValues.rice)
    )   
  }
